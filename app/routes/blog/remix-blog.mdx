---
title: "Make and deploy your own blog under 30 mins"
date: 2022-03-13
meta:
  title: Make and deploy your own blog under 30 mins
  description: In this blog, I will show you how to setup a blog with Remix, TailwindCSS, MDX and deploy it to Vercel.
---
...
First, delete the `app/styles` directory (that was our compiled css that was generated) and then upload this code to [GitHub](https://github.com). I'm assuming you know how to do that, if you don't, just look it up online.
...
That's it for today, damn this was a long one. If you made it this far, I really appreciate you reading!
